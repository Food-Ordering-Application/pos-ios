...
//    var index: Int?
    ...
    var toppingItems: Array<CSToppingItem>
    
}

extension CSToppingGroup {
    func toStruct() -> ToppingGroup {
        return ToppingGroup(id: id ?? "", name: name ?? "No name", toppingItems: toppingItems.map({ (csToppingItem) -> ToppingItem in
